...
export default function ToolWrapper({ element }: Props) {
  ...
  const [resizing, setResizing] = useState(false); // ✅ added missing state
  ...
  return (
    <div
      ...
      } rounded bg-white/60 backdrop-blur px-2 py-1`}
      style={{
          ...
          >
            <div
              ...
              style={{
                ...
                fontSize: (props.fontSize ?? 14) * zoom,
                lineHeight: 1.2,
        ...
        {element.type === "checkbox" && (
          <label className="flex items-center gap-2 text-sm break-words">
            <input
              ...
              onChange={(e) =>
                updateElement(id, {
                  properties: { ...props, checked: e.target.checked },
                })
              }
            />
            {props.label ?? ""}
        ...
        {element.type === "radio" && (
          <label className="flex items-center gap-2 text-sm break-words">
            <input
              ...
              onChange={(e) =>
                updateElement(id, {
                  properties: { ...props, selected: e.target.checked },
                })
              }
            />
            {props.label ?? ""}
        ...
        {element.type === "stamp" && (
          <div className="w-full h-full grid place-items-center text-center p-1">
            <span
              ...
              style={{
                fontSize: Math.max(10, size.height * zoom * 0.4),
                lineHeight: 1,
                padding: `${Math.max(2, 0.1 * size.height * zoom)}px`,
              }}
            >
              {props.text ?? "APPROVED"}
            </span>
        ...
        {element.type === "initials" && (
          <div className="w-full h-full grid place-items-center">
            <span
              ...
              style={{ fontSize: Math.max(10, size.height * zoom * 0.6) }}
            >
              {props.value ?? ""}
            </span>
          </div>
      ...
      {editing && (
        <div className="absolute left-0 top-full mt-2 p-3 bg-white border rounded shadow-lg z-20 w-[520px] max-w-[90vw]">
          {element.type === "signature" && (
            <SignatureCanvas
              onChange={(dataUrl) => {
                updateElement(id, { properties: { ...props, dataUrl } });
                setEditing(false);
              }}
            />
          )}
            ...
            <div className="grid gap-2 text-sm">
              ...
              <label className="grid gap-1">
                ...
                <input
                  ...
                  defaultValue={props.fontSize ?? 14}
                  onChange={(e) =>
                    updateElement(id, {
                      properties: {
                        ...props,
              ...
              <label className="grid gap-1">
                ...
                <input
                  type="color"
                  className="w-12 h-8"
                  defaultValue={props.color ?? "#111827"}
                  onChange={(e) =>
                    updateElement(id, {
              ...
              <div className="flex gap-3">
                <label className="grid gap-1">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateElement(id, {
                        properties: { ...props, align: e.target.value },
                      })
                    }
                  >
                ...
                <label className="grid gap-1">
                  ...
                  <select
                    className="px-2 py-1 border rounded"
                    defaultValue={props.valign ?? "top"}
                    onChange={(e) =>
                      updateElement(id, {
                        properties: { ...props, valign: e.target.value },
                      })
                    }
                  >
            ...
            <div className="grid gap-2 text-sm">
              <label className="grid gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateElement(id, {
                      properties: { ...props, value: e.target.value },
                    })
                  }
                />
              </label>
              <label className="grid gap-1">
                ...
                <input
                  ...
                  defaultValue={props.format ?? "YYYY-MM-DD"}
                  onChange={(e) =>
                    updateElement(id, {
                      properties: { ...props, format: e.target.value },
                    })
                  }
                />
              </label>
            ...
            <div className="grid gap-2 text-sm">
              <label className="grid gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateElement(id, {
                      properties: { ...props, label: e.target.value },
                    })
                  }
                />
              </label>
          ...
          {element.type === "stamp" && (
            <div className="grid gap-2 text-sm">
              <label className="grid gap-1">
                ...
                <input
                  className="px-2 py-1 border rounded"
                  defaultValue={props.text ?? "APPROVED"}
                  onChange={(e) =>
                    updateElement(id, {
                      properties: { ...props, text: e.target.value },
                    })
